...
def test_centroid_outside_all_polygons_uses_nearest_polygon():
    polygons = {
        "nose": [(40, 20), (60, 20), (60, 40), (40, 40)],
        "chin_jaw": [(20, 70), (80, 70), (80, 90), (20, 90)],
    }

    assert assign_regions([(48, 48, 52, 52)], polygons) == ["nose"]
...
if __name__ == "__main__":
    ...
    test_centroid_outside_all_polygons_uses_nearest_polygon()
